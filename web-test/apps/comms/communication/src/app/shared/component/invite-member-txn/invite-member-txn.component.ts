...
import { AssignLeftReq, Txn, TxnService } from '@b3networks/chat/shared/core';
...
@Component({
  selector: 'b3n-invite-member-txn',
  templateUrl: './invite-member-txn.component.html',
  styleUrls: ['./invite-member-txn.component.scss']
})
export class InviteMemberTxnComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { txn: Txn },
    private dialogRef: MatDialogRef<InviteMemberTxnComponent>,

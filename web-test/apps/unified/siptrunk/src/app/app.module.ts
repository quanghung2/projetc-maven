...
const routes: Routes = [
  ...
  {
    path: ROUTE_LINK.config_detail,
    loadChildren: () => import('./config-detail/config-detail.module').then(m => m.ConfigDetailModule)
  },
  {
    path: ROUTE_LINK.networking_info,
    loadChildren: () => import('./networking-info/networking-info.module').then(m => m.NetworkingInfoModule)
  },
  {
  ...
  {
    path: ROUTE_LINK.high_availability,
    loadChildren: () => import('./high-availability/high-availability.module').then(m => m.HighAvailabilityModule)
  },
  {
    path: 'access-denied',
